...
angular.module('mechofest').run(['$templateCache', function($templateCache) {$templateCache.put('source/js/directives/banner/about.html','<div class="fest-banner fest-banner-about">\n    <div class="fest-banner-content">\n        <div class="fest-banner-name"></div>\n        <div class="fest-banner-about-name"></div>\n    </div>\n</div>\n');
